 ...
 */
final class Version20201217144036 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE message ADD CONSTRAINT FK_B6BD307F5F477E9 FOREIGN KEY (recruter_destinataire_id) REFERENCES user (id)');
